...
<head>
	...
	<!-- Charts -->
	<!--[if lt IE 9]>
		<script type="text/javascript" src="<?= base_url('assets/plugins/flot/excanvas.min.js')?>"></script>
	<![endif]-->
	...
	<script type="text/javascript" src="<?= base_url('assets/plugins/flot/jquery.flot.growraf.min.js')?>"></script>
	<script type="text/javascript" src="<?= base_url('assets/plugins/easy-pie-chart/jquery.easy-pie-chart.min.js')?>"></script>
	...
	<script type="text/javascript" src="<?= base_url('assets/js/demo/pages_calendar.js')?>"></script>
	<script type="text/javascript" src="<?= base_url('assets/js/demo/charts/chart_filled_blue.js')?>"></script>
	<script type="text/javascript" src="<?= base_url('assets/js/demo/charts/chart_simple.js')?>"></script>
</head>
